...
The run for K=9 was used to attribute individuals to populations. An individual for which more than 60% of its genome comes from a given cluster is attributed to the population of the same name as the cluster.
Individuals which do not draw more than 60% from a single cluster were labelled "admixed".
